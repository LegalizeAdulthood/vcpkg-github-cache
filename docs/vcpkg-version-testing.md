...
1. Add a vcpkg ref resolver script
...
3. Add an integration workflow skeleton
...
5. Add Windows host integration
...
6. Add bounded `develop` coverage
...
7. Add analyzer result assertions
...
8. Add cold-seed and warm-hit passes
...
13. Add missing-dependency probes
...
14. Add the full release matrix
...
15. Add scheduled rotating coverage
...
16. Add canary repository instructions
...
17. Add canary workflow template
...
18. Document release qualification
